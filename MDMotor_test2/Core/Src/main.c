...
//  LED_OnOff(LED_ALL, 500);
  ...
  while (1)
  {
	  HAL_GPIO_WritePin(GPIOF, 12, RESET);
	  HAL_GPIO_WritePin(GPIOF, 13, RESET);
	  HAL_GPIO_WritePin(GPIOF, 14, RESET);
	  HAL_GPIO_WritePin(GPIOF, 2, RESET);
	  HAL_GPIO_WritePin(GPIOD, 7, RESET);
	  HAL_GPIO_WritePin(GPIOE, 3, RESET);

//	  HAL_GPIO_WritePin(GPIOF, 12, SET);
//	  HAL_GPIO_WritePin(GPIOF, 13, SET);
//	  HAL_GPIO_WritePin(GPIOF, 14, SET);
//	  HAL_GPIO_WritePin(GPIOF, 2, SET);
//	  HAL_GPIO_WritePin(GPIOD, 7, SET);
//	  HAL_GPIO_WritePin(GPIOE, 3, SET);
    /* USER CODE END WHILE */
